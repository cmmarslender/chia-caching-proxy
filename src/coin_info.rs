...
use chia_wallet_sdk::prelude::{
    Address, Allocator, Bytes32, CatInfo, FromClvm, NftInfo, Puzzle, ToClvm,
};
...
struct GetCoinInfoRequest {
    name: Bytes32,
}

#[derive(serde::Serialize)]
struct CatInfoResponse {
    asset_id: Bytes32,
...
struct GetCoinInfoResponse {
    ...
    cat_info: Option<CatInfoResponse>,
    #[serde(skip_serializing_if = "Option::is_none")]
    nft_info: Option<NftInfoResponse>,
}
